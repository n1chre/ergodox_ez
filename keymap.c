 ...
 * |--------+------+------+------+------+------|      |           | Tab  |------+------+------+------+------+--------|
 * |Esc/Ctrl|   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |   ;  |Bscp/~L3|
 * |--------+------+------+------+------+------|Cmd+V |           |Shift+|------+------+------+------+------+--------|
